...
(function( jumplist ) {
	...
	var options = {
		...
		siteName: 'Microsoft DevCamps', // Site Name
		applicationName: 'Microsoft DevCamps', // Site Name 
		startURL: '', // Homepage URL 
		shortcutIcon: 'https://buildmypinnedsite.blob.core.windows.net/files/JumpList/634878353715343905/Main-favicon.ico', // Main Site Icon
		tooltip: '',
		...
		barSiteName: 'Microsoft DevCamps' // Site name as it should appear on the pinning bar
	};
